...
void
DiscreteControllerAdapter::setIntervalCount(int intervalCount) {
  this->sensorIntervalCount = intervalCount;
  this->motorIntervalCount = intervalCount;
}

void
DiscreteControllerAdapter::setSensorIntervalCount(int sensorIntervalCount) {
  this->sensorIntervalCount = sensorIntervalCount;
}

void
DiscreteControllerAdapter::setMotorIntervalCount(int motorIntervalCount) {
  this->motorIntervalCount = motorIntervalCount;
}

void
DiscreteControllerAdapter::setIntervalRange(double minRange, double maxRange, bool mapToInterval) {
  this->setMotorIntervalRange(minRange, maxRange, mapToInterval);
  this->setSensorIntervalRange(minRange, maxRange, mapToInterval);
}

void
DiscreteControllerAdapter::setMotorIntervalRange(double minMotorRange,
...
void
DiscreteControllerAdapter::setSensorIntervalRange(double minSensorRange,
...
void
DiscreteControllerAdapter::step(const sensor* sensors,
                                int sensornumber,
                                motor* motors,
                                int motornumber) {
...
void
DiscreteControllerAdapter::stepNoLearning(const sensor* sensors,
                                          int sensornumber,
                                          motor* motors,
                                          int motornumber) {
  this->doDiscretisizeSensorValues(sensors, sensornumber);
...
void
DiscreteControllerAdapter::init(int sensornumber, int motornumber, RandGen* randGen) {
...
void
DiscreteControllerAdapter::doDiscretisizeSensorValues(const sensor* sensors, int sensornumber) {
...
void
DiscreteControllerAdapter::doDiscretisizeMotorValues(motor* motors, int motornumber) {
...
void
DiscreteControllerAdapter::findMinAndMaxSensorRange(const sensor* sensors, int sensornumber) {
  if (this->firstStep) {
...
void
DiscreteControllerAdapter::findMinAndMaxMotorRange(motor* motors, int motornumber) {
  if (this->firstStep) {
...
void
DiscreteControllerAdapter::findMinAndMaxSensorValues(const sensor* sensors, int sensornumber) {
  if (this->firstStep) {
...
void
DiscreteControllerAdapter::findMinAndMaxMotorValues(motor* motors, int motornumber) {
  if (this->firstStep) {
...
double
DiscreteControllerAdapter::discretisizeValue(double valueToDiscretisize,
                                             bool automaticRange,
                                             double minRange,
                                             double maxRange,
                                             double minValue,
  ...
  valueToDiscretisize =
    roundValue((maxRange - valueToDiscretisize) * intervalCount / (maxRange - minRange));
...
double
DiscreteControllerAdapter::roundValue(double valueToRound) {
