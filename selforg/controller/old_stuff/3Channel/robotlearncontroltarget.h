...
template <int NUMBER_CHANNELS, int BUFFER_SIZE=1> class RobotLearnControlTarget{


  protected:
  double eps_target = 0.0; // learning rate for target learning
  ...
  */
  ...
  virtual void explicit setEpsTarget(double x) {
    eps_target = x;
  };
