...
InspectableProxy::InspectableProxy(const iparamkey& name)
  : Inspectable(name) {
  // nothing
}

InspectableProxy::InspectableProxy(const std::list<Inspectable*>& list, const iparamkey& name)
  : Inspectable(name) {
...
bool
InspectableProxy::replaceList(const std::list<Inspectable*>& list) {
