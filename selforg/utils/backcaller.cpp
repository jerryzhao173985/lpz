...
void
BackCaller::addCallbackable(Callbackable* callbackableInstance,
  ...
  callbackableListType::const_iterator listItr =
    find(list->begin(), list->end(), callbackableInstance);
  if (listItr == list->end())
    list->push_back(callbackableInstance);
}

void
BackCaller::removeCallbackable(Callbackable* callbackableInstance,
                               CallbackableType type /* = BackCaller::DEFAULT_CALLBACKABLE_TYPE*/) {
  callbackableListType* list = 0;
  callbackableMapType::const_iterator iterator = callbackableMap.find(type);
  if (iterator != callbackableMap.end())
...
void
BackCaller::removeAllCallbackables(
  CallbackableType type /* = BackCaller::DEFAULT_CALLBACKABLE_TYPE */) {
  callbackableListType* list = 0;
  callbackableMapType::const_iterator iterator = callbackableMap.find(type);
  if (iterator != callbackableMap.end())
...
void
BackCaller::callBack(CallbackableType type /* = BackCaller::DEFAULT_CALLBACKABLE_TYPE*/) {
  callbackableListType* list = 0;
  callbackableMapType::const_iterator iterator = callbackableMap.find(type);
  if (iterator != callbackableMap.end())
    list = (*iterator).second;
...
void
BackCaller::callBackQMP(CallbackableType type /* = BackCaller::DEFAULT_CALLBACKABLE_TYPE*/) {
  callbackableListType* list = 0;
  callbackableMapType::const_iterator iterator = callbackableMap.find(type);
  if (iterator != callbackableMap.end())
    list = (*iterator).second;
  ...
  if (listSize == 1) {
    ...
    callbackableListType derefList =
