...
//                                 , ForcedSphere::getDefaultConf(), __PLACEHOLDER_14__);
      ...
      //  agent->setTrackOptions(TrackRobot(true, false, false, __PLACEHOLDER_24__, 50));
    ...
    for(int i=0; i<sphericalsXYZ; ++i) override {
      ...
      conf.pendularrange=0.35;
      sphere1 = new Sphererobot3Masses ( odeHandle, osgHandle.changeColor(Color(i==1, 0.0, i== nullptr)),
                                                conf, "SphereXYZ", 0.4);
...
//       controller->setParam(__PLACEHOLDER_100__,0.0);//0.005);
...
//     }//creation of flat snakes End
    ...
    for(int r=0; r < hurlings; ++r)  override {
      ...
      (static_cast<OdeRobot*>(snake))->place(Pos(r*3+3,r*2-5, height));
