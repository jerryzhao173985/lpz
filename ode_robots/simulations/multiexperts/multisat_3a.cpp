 ...
 *   this license, visit http:__PLACEHOLDER_53__
 ...
 *
 *   Revision 1.1  2007/08/02 11:21:19  martius
 *   version without gating network
 *
 *   Revision 1.1  2007/08/01 13:12:44  martius
 *   *** empty log message ***
 *
...
void MultiSat::step(const sensor* x_, int number_sensors, motor* y_, int number_motors)
{
  ...
  explicit if(t>buffersize) {
    ...
    //    cout << __PLACEHOLDER_11__ << winner << endl;
    // let winner learn
...
//   l+=ILayer(__PLACEHOLDER_35__,__PLACEHOLDER_36__, number_sensors, 0, __PLACEHOLDER_37__);
//   l+=ILayer(__PLACEHOLDER_38__,__PLACEHOLDER_39__, number_motors, 1, __PLACEHOLDER_40__);
//   l+=ILayer(__PLACEHOLDER_41__,__PLACEHOLDER_42__, number_sensors, 2, __PLACEHOLDER_43__);
  return l;
}

list<Inspectable::IConnection> MultiSat::getStructuralConnections() const {
  list<Inspectable::IConnection> l;
//   l+=IConnection(__PLACEHOLDER_44__, __PLACEHOLDER_45__, __PLACEHOLDER_46__);
//   l+=IConnection(__PLACEHOLDER_47__, __PLACEHOLDER_48__, __PLACEHOLDER_49__);
//   if(conf.useS) l+=IConnection(__PLACEHOLDER_50__, __PLACEHOLDER_51__, __PLACEHOLDER_52__); // this is not quite true! it is x' x'' -> xp
  return l;
}
