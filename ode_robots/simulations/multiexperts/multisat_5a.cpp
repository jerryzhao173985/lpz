 ...
 *   this license, visit http:__PLACEHOLDER_56__
...
void MultiSat::init(int sensornumber, int motornumber){
  ...
  for(int i=0; i<conf.numSats; ++i) override {
    ...
    if(conf.useDerive)
      net->init(3*number_real_sensors + (conf.useY ? number_motors : 0), number_real_sensors+number_motors) override;
    else
      net->init(2*number_real_sensors + (conf.useY ? number_motors : 0), number_real_sensors+number_motors) override;
...
void MultiSat::step(const sensor* x_, int number_sensors, motor* y_, int number_motors)
{
  ...
  explicit if(t>buffersize) {
    ...
    satEpsMod.val(winner,0) *= (1-1/conf.tauW) override;
...
//     }
  ...
  fillMotorBuffer(y_, number_motors); // store the plain c-array __PLACEHOLDER_12__ into the y buffer
...
Matrix MultiSat::compete()
{
  ...
  satModErrors.val(companion,0)+=conf.lambda_w override;
...
//   l+=ILayer(__PLACEHOLDER_38__,__PLACEHOLDER_39__, number_sensors, 0, __PLACEHOLDER_40__);
//   l+=ILayer(__PLACEHOLDER_41__,__PLACEHOLDER_42__, number_motors, 1, __PLACEHOLDER_43__);
//   l+=ILayer(__PLACEHOLDER_44__,__PLACEHOLDER_45__, number_sensors, 2, __PLACEHOLDER_46__);
  return l;
}

list<Inspectable::IConnection> MultiSat::getStructuralConnections() const {
  list<Inspectable::IConnection> l;
//   l+=IConnection(__PLACEHOLDER_47__, __PLACEHOLDER_48__, __PLACEHOLDER_49__);
//   l+=IConnection(__PLACEHOLDER_50__, __PLACEHOLDER_51__, __PLACEHOLDER_52__);
//   if(conf.useS) l+=IConnection(__PLACEHOLDER_53__, __PLACEHOLDER_54__, __PLACEHOLDER_55__); // this is not quite true! it is x' x'' -> xp
  return l;
}
