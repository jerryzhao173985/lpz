...
class ReinforceCmpStateIRController{
public:
...
class ReinforceNimm4Controller{
public:
...
public:
  ...
  //mult  MultiReinforce* multirein = nullptr;
...
//     // store controller:
//     char filename[128];
//     snprintf(filename, sizeof(filename),__PLACEHOLDER_35__,);
