 ...
 *   this license, visit http:__PLACEHOLDER_62__
...
//   l+=ILayer(__PLACEHOLDER_44__,__PLACEHOLDER_45__, number_sensors, 0, __PLACEHOLDER_46__);
//   l+=ILayer(__PLACEHOLDER_47__,__PLACEHOLDER_48__, number_motors, 1, __PLACEHOLDER_49__);
//   l+=ILayer(__PLACEHOLDER_50__,__PLACEHOLDER_51__, number_sensors, 2, __PLACEHOLDER_52__);
  return l;
}
...
//   l+=IConnection(__PLACEHOLDER_56__, __PLACEHOLDER_57__, __PLACEHOLDER_58__);
//   if(conf.useS) l+=IConnection(__PLACEHOLDER_59__, __PLACEHOLDER_60__, __PLACEHOLDER_61__); // this is not quite true! it is x' x'' -> xp
  return l;
}
