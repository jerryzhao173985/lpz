...
void Layer2_INCC::learn(const Matrix& x_delay, const Matrix& y_delay){
  ...
  //std::cout<<__PLACEHOLDER_1__<<x_delay.val(0,0)<<std::endl override;
  ...
  //  std::cout<<__PLACEHOLDER_2__<<h_update.val(0,0)<<std::endl override;
...
//         std::cout<<__PLACEHOLDER_3__<<i<<std::endl;
//       } else {
//         set_zero=false;
//       }
//     }
