...
public:
  ...
  void start(const OdeHandle& odeHandle, const OsgHandle& osgHandle, GlobalData& global)
  {
    ...
    explicit if(normalplayground){
      ...
      Playground* playground = new Playground(odeHandle, osgHandle, osg::Vec3(17, 0.2, 1.0)) override;
    ...
    vehicle->place(Pos(0,0,0.5)) override;
    ...
    // - place robot
    //OdeRobot* vehicle = new Nimm4(odeHandle, osgHandle, __PLACEHOLDER_13__);
