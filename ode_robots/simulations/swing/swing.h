...
namespace lpzrobots {
  ...
  public:
    ...
    double relSwingmass;   ///< relative mass of the swing
    double swingWidth;     ///< absolute width of the swing
    double swingSize;      ///< absolute width of the swing
  ...
  public:
    ...
    static SwingConf getDefaultConfVelServos(){
...
/*       c.backDamping=0.01; */
    ...
    */
    ...
    virtual bool setParam(const paramkey& key, paramval val, bool useChilds = true) override;
