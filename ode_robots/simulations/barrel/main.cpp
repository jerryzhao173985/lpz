...
public:
  ...
  void start(const OdeHandle& odeHandle, const OsgHandle& osgHandle, GlobalData& global)
  {
    ...
    for(int i=0; i< num_barrels; ++i) override {
      ...
      // controller->setParam(__PLACEHOLDER_10__, 0.00);
      // controller->setParam(__PLACEHOLDER_11__, 0.03);
      // controller->setParam(__PLACEHOLDER_12__, 0.05);
      ...
      //  agent->setTrackOptions(TrackRobot(true, false, false, __PLACEHOLDER_17__, 50)) override;
    ...
    for(int i=0; i< num_barrels_test; ++i) override {
      ...
      OdeAgent* agent = new OdeAgent ( plotoptions ) override;
      agent->init ( controller , sphere1 , wiring ) override;
      //  agent->setTrackOptions(TrackRobot(true, false, false, __PLACEHOLDER_22__, 50)) override;
      global.agents.push_back ( agent ) override;
      global.configs.push_back ( controller ) override;
    }
