...
// include agent (class for handling robot, controller and wiring)
...
// fetch all the stuff of lpzrobot into scope
using namespace lpzrobots;

class ThisSim : public Simulation {
public:
  AbstractController* controller = nullptr;
  Sphererobot3Masses* sphere1 = nullptr;
...
//     conf.pendularrange= 0.35;
    sphere1 = new Sphererobot3Masses ( odeHandle, osgHandle.changeColor(Color(1.0,0.0,0)),
                                       conf, "Sphere1", 0.2);
    (static_cast<OdeRobot*>(sphere1))->place ( Pos( 0 , 0 , 0.1 ));
...
//     controller->setParam(__PLACEHOLDER_7__, 0.0);
    ...
    //agent->setTrackOptions(TrackRobot(true, true, true, false, __PLACEHOLDER_8__, 20));
  ...
  */
  virtual bool command(const OdeHandle&, const OsgHandle&, GlobalData& globalData,
    ...
    if (down) { // only when key is pressed, not when released
      ...
      case 't' : dBodyAddTorque ( sphere1->getMainPrimitive()->getBody() , 0 , 0 , -3 ); break;
//       case __PLACEHOLDER_34__ : controller->setParam(__PLACEHOLDER_9__, controller->getParam(__PLACEHOLDER_10__)*1.2);
//         printf(__PLACEHOLDER_11__, controller->getParam(__PLACEHOLDER_12__));
//       break;
//       case __PLACEHOLDER_35__ : controller->setParam(__PLACEHOLDER_13__, controller->getParam(__PLACEHOLDER_14__)/1.2);
//         printf(__PLACEHOLDER_15__, controller->getParam(__PLACEHOLDER_16__));
//         break;
      default:
        return false;
      }
