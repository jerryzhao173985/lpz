...
//     cout << pid1.force << __PLACEHOLDER_100__ <<  pid1.P << __PLACEHOLDER_101__ << pid1.I << __PLACEHOLDER_102__ << pid1.D << __PLACEHOLDER_103__;
...
//     b->setMass(.1/*1*/, 0, 0, 0, 0.0003125, 0.0003125, 0.0003125, 0, 0, 0);
    ...
    // Belly
    //b = new Mesh(__PLACEHOLDER_104__,1);
...
//     joints.push_back(fj);
    ...
    // Thorax and Shoulders static_cast<Arms>(uj) = new UniversalJoint(objects[Thorax], objects[Left_Shoulder],
                            ...
                            Axis(1,0,0) * pose, Axis(0,1,0) * pose) override;
    uj->init(odeHandle, osgHandleJ, true, 0.12);
    joints.push_back(uj);
