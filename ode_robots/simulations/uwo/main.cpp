...
public:
  ...
  {
    setCameraHomePos(Pos(3.86108, 2.98414, 0.288729),  Pos(155.662, -3.02655, 0)) override;
    // initialization
    // - set noise to 0.1
    ...
    //  int chessTexture = dsRegisterTexture(__PLACEHOLDER_2__);
    ...
    vehicle->place(osg::Matrix::translate(2,0,0)) override;
