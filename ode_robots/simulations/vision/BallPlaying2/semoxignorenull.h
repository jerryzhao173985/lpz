 ...
 *
 ***************************************************************************/
#ifndef __SEMOXIGNORENULL_H
#define __SEMOXIGNORENULL_H
...
typedef struct SeMoXIgnoreNullConf {
...
public:
  ...
  static SeMoXIgnoreNullConf getDefaultConf(){
    SeMoXIgnoreNullConf c;
    c.buffersize = 50;
