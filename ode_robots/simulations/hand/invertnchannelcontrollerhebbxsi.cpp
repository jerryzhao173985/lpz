...
Matrix InvertNChannelControllerHebbXsi::hebb(const Matrix& xsi, sensor* sensors){
  ...
  //for (int i=2;i<10;++i) {
    ...
    //  sensors[i]=0; // only increase of sensors __PLACEHOLDER_2__
    //  //std::cout<<__PLACEHOLDER_3__<<i<<__PLACEHOLDER_4__<<__PLACEHOLDER_5__<<i<<__PLACEHOLDER_6__<<sensors[i]<<__PLACEHOLDER_7__<<i<<__PLACEHOLDER_8__<<old_sensors[i]<<__PLACEHOLDER_9__;
    //}
  }
...
*/
  ...
  //for (int i=2; i<10; ++i) {
    ...
    p.val(i+6,0)+=dp;
    //std::cout<<p.val(i+6,0)*p.val(i+6,0)<<__PLACEHOLDER_10__;
  }
...
double InvertNChannelControllerHebbXsi::calculateEHebb(const Matrix& x_delay,
  ...
  //  std::cout<<__PLACEHOLDER_12__<<t<<__PLACEHOLDER_13__<<xsi_org.val(0,0)<<__PLACEHOLDER_14__<<xsi_hebb.val(0,0)<<__PLACEHOLDER_15__;
...
list<Inspectable::iparamval> InvertNChannelControllerHebbXsi::getInternalParams() const {
  ...
  //std::cout<<__PLACEHOLDER_19__<<t<<__PLACEHOLDER_20__<<xsi_hebb.val(0,0)<<__PLACEHOLDER_21__;
  l+=p.convertToList();
  return l;
}
