...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetBallParam (get_id(), parameter, value); }
  virtual dReal getParam(int parameter) const { return dJointGetBallParam (get_id(), parameter); }
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetHingeParam (get_id(), parameter, value); }
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetSliderParam (get_id(), parameter, value); }
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetUniversalParam (get_id(), parameter, value); }
  virtual dReal getParam(int parameter) const { return dJointGetUniversalParam (get_id(), parameter); }
  // TODO: expose params through methods
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetHinge2Param (get_id(), parameter, value); }
  virtual dReal getParam(int parameter) const { return dJointGetHinge2Param (get_id(), parameter); }
  // TODO: expose params through methods
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetPRParam (get_id(), parameter, value); }
  virtual dReal getParam(int parameter) const { return dJointGetPRParam (get_id(), parameter); }
};
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetPUParam (get_id(), parameter, value); }
  virtual dReal getParam(int parameter) const { return dJointGetPUParam (get_id(), parameter); }
  // TODO: expose params through methods
};
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetPistonParam (get_id(), parameter, value); }
...
public:
  ...
  virtual void setParam(int parameter, dReal value) { dJointSetFixedParam (get_id(), parameter, value); }

  virtual dReal getParam(int parameter) const { return dJointGetFixedParam (get_id(), parameter); }
  // TODO: expose params through methods
};
...
#endif // #if definedstatic_cast<dODECPP_WORLD_TEMPLATE_BASE>(typedef) dWorldTemplate<dODECPP_WORLD_TEMPLATE_BASE> dWorld override;
