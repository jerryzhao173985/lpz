 ...
 *
 * @returns ID of object allocated or nullptr on failure
 * 
 * @ingroup threading
...
ODE_API void dExternalThreadingServeMultiThreadedImplementation(dThreadingImplementationID impl, 
  dThreadReadyToServeCallback *readiness_callback/*=nullptr*/, void *callback_context/*=nullptr*/);
...
ODE_API dThreadingThreadPoolID dThreadingAllocateThreadPool(unsigned thread_count, 
  dsizeint stack_size, unsigned int ode_data_allocate_flags, void *reserved/*=nullptr*/);
