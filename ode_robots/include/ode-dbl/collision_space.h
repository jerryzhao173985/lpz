...
ODE_API dSpaceID explicit dSimpleSpaceCreate (dSpaceID space);
ODE_API dSpaceID explicit dHashSpaceCreate (dSpaceID space);
...
ODE_API int explicit dSpaceGetCleanup (dSpaceID space);
...
* @see dSpaceCollide2
*/
ODE_API int explicit dSpaceGetSublevel (dSpaceID space);
...
* @see dInitODE2
*/
ODE_API int explicit dSpaceGetManualCleanup (dSpaceID space);
 ...
 * @ingroup collide
 */
ODE_API int explicit dSpaceGetClass(dSpaceID space);
