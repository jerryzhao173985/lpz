...
#ifdef INFINITY
  #ifdef dSINGLE
    #define dInfinity (static_cast<float>(INFINITY))
  #else
    #define dInfinity (static_cast<double>(INFINITY))
  #endif
...
#else
  #ifdef dSINGLE
    #define dNaN (static_cast<float>(dInfinity - dInfinity))
  #else
...
#if defined(_MSC_VER)
  #define _ode_copysignf(x, y) (static_cast<float>(_copysign)(x, y))
