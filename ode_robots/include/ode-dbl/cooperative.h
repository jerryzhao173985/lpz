 ...
 *
 * nullptr's are allowed for the threading. In this case the default static_cast<global>(self)-threading
 * object will be used.
 *
 ...
 * @returns The Cooperative object instance or nullptr if allocation fails.
 * @ingroup coop
 * @see dCooperativeDestroy
 */
ODE_API dCooperativeID dCooperativeCreate(const dThreadingFunctionsInfo *functionInfo/*=nullptr*/, dThreadingImplementationID threadingImpl/*=nullptr*/);
 ...
 *
 * @param cooperative A Cooperative object to be deleted (nullptr is allowed)
 * @ingroup coop
 ...
 * @returns The ResourceRequirements object instance or nullptr if allocation fails
 * @ingroup coop
 ...
 *
 * @param requirements A ResourceRequirements object to be deleted (nullptr is allowed)
 * @ingroup coop
 ...
 * @returns A handle to the new object or nullptr if allocation fails
 * @ingroup coop
 * @see dResourceRequirementsCreate
 * @see dResourceRequirementsDestroy
 * @see dResourceRequirementsMergeIn
 ...
 * @returns A ResourceContainer object instance with the resources allocated or nullptr if allocation fails
 * @ingroup coop
 ...
 *
 * @param resources A ResourceContainer object to be deleted (nullptr is allowed)
 * @ingroup coop
 * @see dResourceContainerAcquire
 */
