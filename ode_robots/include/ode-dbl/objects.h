 ...
 */
ODE_API int dWorldUseSharedWorkingMemory(dWorldID w, dWorldID from_world/*=nullptr*/);
 ...
 * are used.
 *
 * Passing @a policyinfo argument as nullptr results in reservation policy being
 ...
 * @see dWorldUseSharedWorkingMemory
 */
ODE_API int dWorldSetStepMemoryReservationPolicy(dWorldID w, const dWorldStepReserveInfo *policyinfo/*=nullptr*/);
...
*
* Passing @a memfuncs argument as nullptr results in memory manager being
 ...
 *
 * At least one of the axes must be not nullptr. If nullptr is passed, the corresponding 
