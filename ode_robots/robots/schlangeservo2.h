...
namespace lpzrobots {
  ...
  public:
     ...
     */
    virtual int getSensorNumberIntern() const override { assert(created); return 2*servos.size(); }

    /** returns number of motors
     */
    virtual int getMotorNumberIntern() const override { assert(created); return 2*servos.size(); }
