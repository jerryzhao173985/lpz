...
/* pi and 1/sqrt2 defined here if necessary because they don't get
 ...
 *   AASSERT  is an arguments assertion, i.e. if it fails a nice error message
 *            is printed.
 ...
 * 1 that a geom has moved, 2 the next geom in a body list.
