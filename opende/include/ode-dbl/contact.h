 ...
 * environment, the contact is represented by one or more contact points, described by dContactGeom.
 *
 ...
 * zero. This means that the normal vector points out of to body 1.
 *
 * @ingroup collide
 */
