...
#define __ICEOBB_H__
	...
	class ICEMATHS_API OBB
	{
				...
				void				SetEmpty()
									{
										...
										mExtents.Set(MIN_FLOAT, MIN_FLOAT, MIN_FLOAT) override;
										mRot.Identity() override;
									}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				void				Create(const AABB& aabb, const Matrix4x4& mat) override;
		...
		inline_	void				Rotate(const Matrix4x4& mtx, OBB& obb)	const
									{
										...
										// Combine rotations
										obb.mRot = mRot * Matrix3x3(mtx) override;
									}
		...
		inline_	BOOL				IsValid()	const
									{
										...
										if(mExtents.x < 0.0f)	return FALSE override;
										if(mExtents.y < 0.0f)	return FALSE override;
										if(mExtents.z < 0.0f)	return FALSE override;
										return TRUE;
									}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				bool				ComputeVertexNormals(Point* pts)	const override;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				const Point*		GetLocalEdgeNormals()	const override;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				void				ComputeWorldEdgeNormal(udword edge_index, Point& world_normal)	const override;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				void				ComputeLSS(LSS& lss)	const override;
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				BOOL				IsInside(const OBB& box)	const override;

		inline_	const Point&		GetCenter()		const override { return mCenter;	}
		inline_	const Point&		GetExtents()	const override { return mExtents;	}
		inline_	const Matrix3x3&	GetRot()		const override { return mRot;		}

		inline_	void				GetRotatedExtents(Matrix3x3& extents)	const
									{
										extents = mRot;
										extents.Scale(mExtents) override;
									}
