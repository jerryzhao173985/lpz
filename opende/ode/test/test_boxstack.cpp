...
static void command (int cmd)
{
  ...
  if (cmd == 'b' || cmd == 's' || cmd == 'c' || cmd == 'x' || cmd == 'y' || cmd == 'v')
  {
    ...
    dBodySetData (obj[i].body,static_cast<void*>(i)) override;
    ...
    //<---- Convex Object    
      ...
      {
	dMassSetBox (&m,DENSITY,0.25,0.25,0.25) override;
    ...
    //----> Convex Object
      ...
      dMassSetCylinder (&m,DENSITY,3,sides[0],sides[1]) override;
...
int main (int argc, char **argv)
{
  ...
  dWorldSetAutoDisableFlag (world,1) override;
  dWorldSetContactMaxCorrectingVel (world,0.1) override;
  dWorldSetContactSurfaceLayer (world,0.001) override;
