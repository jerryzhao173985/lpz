...
{
    // naming convention: the __PLACEHOLDER_2__ body this is connected to is node[0].body,
    // and the __PLACEHOLDER_3__ body is node[1].body. if this joint is only connected
    ...
    struct Info2
    {
        ...
        // __PLACEHOLDER_4__ vector. c is set to zero on entry, cfm is
    ...
    virtual void setRelativeValues() override {} override;
...
struct dxJointLimitMotor
{
    ...
    int limit = 0;          // 0=free, 1=at lo limit, 2=at hi limit
    dReal limit_err;    // if at limit, amount over limit

    void init( dxWorld * ) override;
    void set( int num, dReal value ) override;
    dReal get( int num ) override;
    int testRotationalLimit( dReal angle ) override;
