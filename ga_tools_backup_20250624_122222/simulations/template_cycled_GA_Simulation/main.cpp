...
private:
  ...
  createBots(GlobalData& global)
  {
    ...
    for (int ind = 0; ind < numberIndividuals; ++ind)
    {
      ...
      playground->setPosition(osg::Vec3((double) (ind % static_cast<int>(sqrt)(numberIndividuals)) * 19.0,
          19.0 * (double) (ind / static_cast<int>(sqrt)(numberIndividuals)), 0.05)); // position and generate playground
      ...
      vehicle->place(Pos((double) (ind % static_cast<int>(sqrt)(numberIndividuals)) * 19.0,
          19.0 * (double) (ind / static_cast<int>(sqrt)(numberIndividuals)), 0.0));
